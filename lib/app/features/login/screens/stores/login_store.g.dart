...
mixin _$LoginStore on _LoginStoreBase, Store {
  ...
  final _$_isLoadingAtom = Atom(name: '_LoginStoreBase._isLoading');
  ...
  final _$_hasErrorAtom = Atom(name: '_LoginStoreBase._hasError');
  ...
  dynamic setIsHasError({bool value = false}) {
    final _$actionInfo = _$_LoginStoreBaseActionController.startAction(
        name: '_LoginStoreBase.setIsHasError');
    try {
